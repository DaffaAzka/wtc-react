  ...
  const filtered = useMemo(() => {
    ...
    return data.filter(
      (track) =>
        ...
        track.slug.toLowerCase().includes(q),
    );
  }, [data, search]);
      ...
      <div className="overflow-hidden rounded-md border border-border">
        ...
        : error ?
          <EmptyState
            ...
            description="Something went wrong while fetching your tracks."
            action={
              onRetry && (
            ...
            <tbody className="divide-y divide-border">
              {filtered.map((track) => {
                const updated = formatUpdated(
                  (track as unknown as { updated_at?: string }).updated_at,
                );
                return (
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              variant="destructive"
                              onClick={() =>
                                setDeleteModal({ data: track, isOpen: true })
                              }>
                              Delete
                            </DropdownMenuItem>
                          </DropdownMenuContent>
