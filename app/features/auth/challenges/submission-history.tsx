        ...
        {submissions.map((submission, index) => {
          ...
          return (
            <div
              ...
              {/* Icon */}
              <div
                className={`shrink-0 w-8 h-8 rounded-full ${s.bg} flex items-center justify-center mt-0.5`}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span
                    className={`inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-bold uppercase tracking-[0.08em] ${s.bg} ${s.text}`}>
