    ...
    <div className="space-y-7">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          {
            label: "Kelas",
            value: profile.study_class?.name || "—",
            icon: null,
            color: "",
            bg: "",
          },
          ...
          <div
            key={label}
            className="rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-4">
            {Icon && (
              <div
                className={`w-7 h-7 rounded-full ${bg} flex items-center justify-center mb-2`}>
      ...
      {lastSubmission &&
        (() => {
          ...
          const s =
            STATUS_STYLE[submission.status ?? "draft"] ?? STATUS_STYLE.draft;
          return (
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-2 flex-wrap">
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-[0.08em] ${s.bg} ${s.text}`}>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          {profile.study_class && (
            <p className="text-[12px] text-gray-400 dark:text-gray-600">
              Kelas saat ini: {profile.study_class.name} (
