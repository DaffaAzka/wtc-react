...
// Extend Track with optional creator field returned by the API
      ...
      <div className="overflow-hidden rounded-md border border-border">
          ...
          <div className="divide-y divide-border">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="flex items-center gap-4 px-4 py-3">
                ...
                <div className="hidden h-3.5 w-56 animate-pulse rounded bg-muted sm:block" />
        ...
        : error ?
          <EmptyState
            ...
            description="Something went wrong while fetching tracks."
            action={
              onRetry && (
        ...
        : <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              {filtered.map((track) => (
                <tr key={track.id} className="group hover:bg-muted/40">
                    ...
                    <div className="flex items-center justify-end gap-1 opacity-0 transition-opacity group-hover:opacity-100">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onClick={() =>
                              setEditModal({ data: track, isOpen: true })
                            }>
                            Update
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            variant="destructive"
                            onClick={() =>
                              setDeleteAlert({ data: track, isOpen: true })
                            }>
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
