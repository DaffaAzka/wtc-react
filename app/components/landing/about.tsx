...
export function AboutSection() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="relative flex flex-col justify-center min-h-screen pt-20 px-6 sm:px-10 lg:px-20 overflow-hidden bg-black">
      <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div
          className={`relative w-full transition-all duration-1000 ease-out delay-200 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          {/* Frame Foto */}
          <div
