...
export function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="relative flex flex-col justify-center min-h-screen pt-20 px-6 sm:px-10 lg:px-20 overflow-hidden bg-black">
      <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className={`transition-all duration-700 ease-out ${inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
          <p className="text-[13px] font-bold uppercase tracking-[0.15em] mb-6" style={{ color: "#1c81ff" }}>
            {copy.tag}
          </p>
          ...
          <p className="text-[16px] lg:text-[18px] leading-relaxed max-w-[480px]" style={{ color: "#888888" }}>
            {copy.sub}
          </p>
        ...
        <div className={`relative w-full transition-all duration-1000 ease-out delay-200 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          {/* Frame Foto */}
          <div
            className="relative w-full rounded-2xl md:rounded-b-2xl rounded-b-none overflow-hidden"
            style={{
              aspectRatio: "4/3",
              ...
              {teamDevPhotos.map((_, i) => (
                <button
                  ...
                  style={{
                    ...
                    background: i === currentSlide ? "#1c81ff" : "rgba(255,255,255,0.3)",
                  }}
          ...
          <div
            ...
            style={{
              background: "radial-gradient(circle, #1c81ff 0%, transparent 70%)",
            }}
          />
        </div>
      </div>
      <div className="absolute bottom-0 left-0 right-0 h-24 transition-opacity duration-300 bg-linear-to-t from-black from-5% to-transparent to-95% z-0 opacity-90" />
    </section>
  );
}
