    ...
    <div className="dark min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:flex lg:min-h-screen lg:items-center lg:px-8">
          <div
            className={`lg:w-1/2 lg:pr-12 transition-all duration-700 ${
          ...
          >
            ...
            <p className="mb-8 text-lg text-muted-foreground/90 sm:text-xl">
              Learn modern web development through hands-on projects, expert mentorship,
              and industry-ready curriculum. Join thousands of developers leveling up their skills.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              From beginner to professional, we've got you covered with comprehensive learning paths
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-8 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-primary/30 hover:bg-card/60 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <div className="relative">
                ...
                <p className="mb-4 text-muted-foreground">
                  Learn through hands-on coding exercises, real-world projects, and instant feedback from our platform
                </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-8 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-primary/30 hover:bg-card/60 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <div className="relative">
                ...
                <p className="mb-4 text-muted-foreground">
                  Build portfolio-worthy projects with modern tools and frameworks used by top tech companies
                </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-8 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:border-primary/30 hover:bg-card/60 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <div className="relative">
                ...
                <p className="mb-4 text-muted-foreground">
                  Get personalized guidance from experienced developers and industry professionals every step of the way
                </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:border-primary/30 hover:bg-card/50 hover:shadow-xl hover:shadow-primary/10">
              ...
              <div className="mb-6 inline-flex rounded-xl bg-primary/10 p-4 transition-all duration-300 group-hover:scale-110 group-hover:bg-primary/20">
                <svg
                  className="size-8 text-primary transition-transform duration-300 group-hover:rotate-12"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="mb-6 text-muted-foreground">
                Join thousands of learners, get help from mentors, and
                collaborate with peers in our vibrant community.
              </p>

              {/* Link */}
              <Link
                to="/help"
                className="inline-flex items-center gap-2 text-sm font-medium text-primary transition-all duration-300 hover:gap-3 hover:text-primary/80"
              >
                Join Community
                <svg
                  className="size-4"
      ...
      <section className="border-t border-border/50 bg-background py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              Learn the most in-demand tools and frameworks used by top companies
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="group relative">
              ...
              <p className="text-muted-foreground">
                Explore our comprehensive library of courses and choose your learning path
              </p>
            </div>
            ...
            <div className="group relative">
              ...
              <p className="text-muted-foreground">
                Follow along with video lessons, coding exercises, and quizzes
              </p>
            </div>
            ...
            <div className="group relative">
              ...
              <p className="text-muted-foreground">
                Apply your skills by building real-world projects for your portfolio
              </p>
            </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Everything you need to know about WTC
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${
                  activeAccordion === 0 ? 'max-h-48' : 'max-h-0'
                }`}
              >
            ...
            <div className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${
                  activeAccordion === 1 ? 'max-h-48' : 'max-h-0'
                }`}
              >
                <p className="px-6 pb-6 text-muted-foreground">
            ...
            <div className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${
                  activeAccordion === 2 ? 'max-h-48' : 'max-h-0'
                }`}
              >
                <p className="px-6 pb-6 text-muted-foreground">
                  Absolutely! All courses are self-paced. Learn when it fits your schedule, with lifetime access to course materials.
                </p>
              </div>
            </div>
            ...
            <div className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${
                  activeAccordion === 3 ? 'max-h-48' : 'max-h-0'
                }`}
              >
                <p className="px-6 pb-6 text-muted-foreground">
                  Yes! Upon completing a course, you'll receive a certificate that you can share on LinkedIn and with potential employers.
                </p>
              </div>
            </div>
            ...
            <div className="group rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/50">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ${
                  activeAccordion === 4 ? 'max-h-48' : 'max-h-0'
                }`}
              >
                <p className="px-6 pb-6 text-muted-foreground">
      ...
      <section className="relative overflow-hidden border-t border-border/50 bg-gradient-to-br from-primary/10 via-background to-background py-24">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-10 text-xl text-muted-foreground">
            Join thousands of developers who are already building their future with us
          </p>
          <Link
            to="/register"
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="mb-4 text-sm text-muted-foreground">
                Master web technology through hands-on learning and expert guidance
              </p>
              ...
              <p className="text-xs text-muted-foreground/60">
                © {new Date().getFullYear()} Webtech Training Camp. All rights reserved.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><Link to="/tracks" className="hover:text-primary">Learning Tracks</Link></li>
