      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0b1215] shadow-sm">
                  ...
                  return (
                    <Link
                      ...
                      <div className="flex items-center gap-3">
                        <Icon
                          className={`h-4 w-4 shrink-0 ${isActive ? "text-[#1c81ff]" : "text-gray-400 dark:text-gray-600"}`}
                        />
                        <div>
                          ...
                          <span
                            className={`block text-[12px] ${isActive ? "text-[#1c81ff]/70" : "text-gray-400 dark:text-gray-600"}`}>
                            {info?.description}
                          </span>
                        </div>
                      </div>
                      {info?.key && (
                        <kbd
                          className={`shrink-0 rounded-lg border px-1.5 py-0.5 font-mono text-[10px] font-bold ${
                            isActive
          ...
          <div className="relative flex flex-col justify-between overflow-hidden p-8">
            {active && activeInfo ? (
              <>
                ...
                <ActiveIcon
                  className="pointer-events-none absolute -right-8 -top-8 h-40 w-40 text-[#1c81ff]/[0.04]"
                  aria-hidden
                />
        ...
        <div className="flex items-center gap-5 border-t border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-white/[0.02] px-5 py-3">
          {[
            ...
            <span
              key={key}
              className="flex items-center gap-1.5 text-[12px] text-gray-400 dark:text-gray-600">
              <kbd className="rounded-md border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0b1215] px-1.5 py-0.5 font-mono text-[10px]">
                {key}
              </kbd>
              {label}
            </span>
