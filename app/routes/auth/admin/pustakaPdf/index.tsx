    ...
    >
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="w-full sm:w-44">
              <SelectForm name="type" text="Tipe Materi" usePlaceholder withAll value={selectedType} handleChange={setSelectedType} items={TYPE_OPTIONS} />
            </div>
          </div>
        </div>
      </div>
      ...
      {filteredLessons.length > 0 && (
        <p className="text-[13px] text-gray-500 dark:text-gray-400">
          <span className="font-bold text-gray-900 dark:text-white">{totalAttachments}</span> materi ditemukan
        </p>
      )}
      ...
      {filteredLessons.length === 0 ? (
        <div className="rounded-2xl bg-white border border-gray-200 dark:bg-[#0b1215] dark:border-white/10 shadow-sm flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-[15px] font-bold text-gray-900 dark:text-white">Tidak ada materi ditemukan</p>
          <p className="text-[14px] text-gray-500 dark:text-gray-400 mt-1">Coba ubah filter atau tambahkan materi baru</p>
        </div>
      ) : (
