            ...
            {recentTracks.length === 0 ? (
              ...
              <div className="space-y-2">
                {recentTracks.map((track) => (
                  <Link key={track.id} to={`/student/tracks/${track.slug}`} className="flex items-start gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors border border-border/40">
                    <div className="p-2 bg-blue-500/10 rounded-full">
                      <BookOpen className="h-4 w-4 text-blue-500" />
                    </div>
