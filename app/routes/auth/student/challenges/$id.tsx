      ...
      <div className="flex flex-1 overflow-hidden">
              ...
              <div className="rounded-2xl bg-white border border-gray-200 dark:bg-[#0b1215] dark:border-white/10 shadow-sm overflow-hidden">
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/5">
                  ...
                  {isPending ? (
                    ...
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-bold ${hasPassed ? "bg-[#00E676]/10 text-[#00E676]" : "bg-[#ff007b]/10 text-[#ff007b]"}`}>
                      {hasPassed ? (
                  ...
                  {isPending ? (
                    <div className="flex items-start gap-3 rounded-xl bg-[#1c81ff]/5 border border-[#1c81ff]/15 p-4">
                      ...
                      <p className="text-[14px] text-gray-600 dark:text-gray-300">
                        Jawaban kamu sedang dinilai. Refresh halaman ini
                        sebentar lagi.
                      </p>
                    </div>
                  ) : latestSubmission.score !== null ? (
                    <>
                      <div>
                        ...
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-extrabold text-[#1c81ff] tabular-nums">
                            {latestSubmission.score}
                          </span>
                          <span className="text-[15px] text-gray-400 dark:text-gray-600">
                            / {challenge.max_score}
                          </span>
                      ...
                      {hasPassed ? (
                        <div className="flex items-start gap-3 rounded-xl bg-[#00E676]/10 border border-[#00E676]/20 p-4">
                          ...
                          <p className="text-[14px] text-[#00E676]">
                        ...
                        <div className="flex items-start gap-3 rounded-xl bg-[#ff007b]/10 border border-[#ff007b]/20 p-4">
                          ...
                          <p className="text-[14px] text-[#ff007b]">
                            Kamu belum mencapai nilai minimal. Silakan coba
                            lagi.
                          </p>
                        </div>
                      )}
            ...
            <div className="rounded-2xl bg-white border border-gray-200 dark:bg-[#0b1215] dark:border-white/10 shadow-sm p-6">
              ...
              {canSubmit ? (
                ...
                <div className="flex items-start gap-3 rounded-xl bg-red-50 dark:bg-red-500/5 border border-red-200 dark:border-red-500/20 p-4">
                  <AlertCircle className="h-4 w-4 text-red-500 shrink-0 mt-0.5" />
                  <p className="text-[14px] text-red-600 dark:text-red-400">
                    Kamu telah mencapai batas maksimum percobaan untuk challenge
                    ini.
                  </p>
                </div>
              )}
        ...
        <div className="hidden lg:flex w-80 xl:w-96 border-l border-gray-200 dark:border-white/10 bg-white dark:bg-[#0a0f12] h-full flex-col">
          ...
          <div className="px-5 py-4 border-b border-gray-200 dark:border-white/10">
            <p className="text-[11px] font-bold uppercase tracking-[0.12em] text-gray-400 dark:text-gray-500 mb-1">
              Module
            </p>
            <h3
              className="text-[15px] font-extrabold text-gray-900 dark:text-white leading-tight"
              style={{ letterSpacing: "-0.01em" }}>
              {currentModule.title}
            </h3>
          </div>
            ...
            <div className="p-3 space-y-5">
                    ...
                    {sortedLessons.map((lesson, index) => (
                      <button
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <span className="block text-[13px] font-bold text-gray-700 dark:text-gray-300 line-clamp-2">
                            {lesson.title}
                          </span>
                        </div>
                      </button>
              ...
              {moduleChallenges.length > 0 && (
                <div className="pt-3 border-t border-gray-100 dark:border-white/5">
                  ...
                  <p className="px-3 mb-2 text-[11px] text-gray-400 dark:text-gray-600">
                    Selesaikan untuk membuka modul berikutnya
                  </p>
                  <div className="space-y-0.5">
                      ...
                      return (
                        <Link key={ch.id} to={`/student/challenges/${ch.id}`}>
                          <div
                            ...
                            {status === "failed" && (
                              <XCircle className="h-4 w-4 shrink-0 text-[#ff007b]" />
                            )}
