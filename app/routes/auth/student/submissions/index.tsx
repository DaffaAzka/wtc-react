...
export default function MySubmissions() {
  ...
  const handleDownload = (submissionId?: number) => {
    if (submissionId === undefined || submissionId === null) return;
      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <Card className="p-8 max-w-md text-center">
          ...
          <p className="text-destructive mb-4">
            {error.message || "Gagal memuat data submisi."}
          </p>
                    ...
                    <TableRow key={submission.id}>
                      <TableCell>
                        <div className="font-medium">
                          {submission.challenge?.title || "Untitled"}
                        </div>
                        {submission.feedback && (
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-between px-6 py-4 border-t">
                  <div className="text-sm text-muted-foreground">
                    ...
                    dari {filteredSubmissions.length} submisi
                  </div>
      ...
      <Dialog
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Informasi lengkap tentang submisi Anda
            </DialogDescription>
          </DialogHeader>
          {selectedSubmission && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="mt-1">
                    {getStatusBadge(selectedSubmission.status ?? "submitted")}
                  </div>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">
